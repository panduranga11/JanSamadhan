...
import { getComplaints } from '../services/complaintService'; // Mock service
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-center bg-surface-light dark:bg-surface-dark p-6 rounded-2xl shadow-sm border border-border-light dark:border-border-dark">
                <div>
                    <h1 className="text-2xl font-bold text-text-light dark:text-text-dark">My Complaints</h1>
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Track and manage your submitted grievances</p>
                </div>
